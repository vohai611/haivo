...
The key point of SA is that, it move search focus to a worse solution in order to find the better one. This characteristic help algorithm to not stuck in local optimum.
