...
to find the solution for Capacitated Vehicle Routing Problem ([CVRP](https://en.wikipedia.org/wiki/Vehicle_routing_problem)). I using shiny to visualize the algorithm result on several benchmark data set. You can find all my code and my basic shiny app on [github](https://github.com/vohai611/cvrp-genetic).
